...
python main.py -data mimic -d_model 10 -kernel_type 2  -epoch 500 -lr 0.001  -batch 32
python main.py -data mimic -d_model 12 -kernel_type 2  -epoch 500 -lr 0.001  -batch 32
python main.py -data mimic -d_model 14 -kernel_type 2  -epoch 500 -lr 0.001  -batch 32
python main.py -data mimic -d_model 16 -kernel_type 2  -epoch 500 -lr 0.001  -batch 32
