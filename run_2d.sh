...
python main.py -data mimic -d_model 8 -kernel_type 2  -epoch 500 -lr 0.001  -batch 8
...
python main.py -data mimic -d_model 16 -kernel_type 2  -epoch 500 -lr 0.001  -batch 8
