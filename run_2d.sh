...
python main.py -data 2_d_hawkes -d_model 32 -d_type 32 -kernel_type 2  -epoch 250 -lr 0.00003 -batch 30  -timetovec 0 -softmax 0 -regularize 0
python main.py -data 2_d_hawkes -d_model 32 -d_type 32 -kernel_type 2  -epoch 250 -lr 0.00003 -batch 30  -timetovec 0 -softmax 1 -regularize 1
#gi
