...
python main.py -data 2_d_hawkes -d_model 32 -d_type 32 -kernel_type 2  -epoch 100 -lr 0.0001 -batch 20  -timetovec 0 -softmax 1
python main.py -data power_hawkes -d_model 32 -d_type 32 -kernel_type 2  -epoch 100 -lr .0001 -batch 20  -timetovec 0 -softmax 1
python main.py -data sin_hawkes -d_model 32 -d_type 32 -kernel_type 2  -epoch 100 -lr .0001 -batch 20  -timetovec 0 -softmax 1

python main.py -data 2_d_hawkes -d_model 32 -d_type 32 -kernel_type 2  -epoch 100 -lr 0.0001 -batch 20  -timetovec 1 -softmax 1
python main.py -data power_hawkes -d_model 32 -d_type 32 -kernel_type 2  -epoch 100 -lr .0001 -batch 20  -timetovec 1 -softmax 1
python main.py -data sin_hawkes -d_model 32 -d_type 32 -kernel_type 2  -epoch 100 -lr .0001 -batch 20  -timetovec 1 -softmax 1
#
#
